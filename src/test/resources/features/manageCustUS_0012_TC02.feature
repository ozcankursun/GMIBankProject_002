@testcasetwo
  Feature: US_012_TC02 View Button


    @viewoption
    Scenario:  TC_0002 There should be a View option where customer can be navigated to all customer info and see edit button there
